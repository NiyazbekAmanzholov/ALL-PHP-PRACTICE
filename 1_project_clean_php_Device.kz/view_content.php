...
include("include/auth_cookie.php");
    ...
    $id = clear_string($_GET["id"]);
     ...
     //код который фиксирует количество просмотров
If ($id != $_SESSION['countid'])//для того чтобы обновлять колич просмотров 1 раз
{
...
$(document).ready(function(){
    ...
    $("ul.tabs").jTabs({content: ".tabs_content", animate: true, effect:"fade"});//вкладки
    $(".image-modal").fancybox(); //слайдер картинок
...
<p id="style-price" >'.group_numerals($row1["price"]).' KZT</p>
...
//вывод описания и хорактеристик
