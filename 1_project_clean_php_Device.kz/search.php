...
<!--//смс если меньше 3 и больше 150-->
<?php
...
//если товаров нет выводим смс
if ($temp[0] > 0)
{

echo '    
<div id="block-sorting">
      <p id="nav-breadcrumbs"><a href="index.php">Главная страница</a> \ Поиск</p>
      <ul id="options-list">
      <li>Вид:</li>       
...
{
  echo "<p>Поисковое значение должно быть от 3 до 150 симвалов!</p>";
}
 ?>
	</div>
