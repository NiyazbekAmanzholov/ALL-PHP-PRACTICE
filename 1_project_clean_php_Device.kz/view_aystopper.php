...
<div id="block-sorting">
      <p id="nav-breadcrumbs"><a href="index.php">Главная страница</a> \ <?php echo $name_aystopper; ?></p>
      <ul id="options-list">
      <li>Вид:</li>       
      ...
      <li><a id="select-sort" href="index.php">Без сортировки</a></li>
        <li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-asc">От дешевых</a></li>
        <li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-desc">От дорогих</a></li>
