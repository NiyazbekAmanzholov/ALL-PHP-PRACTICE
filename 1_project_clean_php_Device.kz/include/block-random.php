...
$query_random = mysql_query("SELECT DISTINCT * FROM table_products WHERE visible='1' ORDER by RAND() LIMIT 5",$link);  
...
<p class="random-price">'.group_numerals($res_query["price"]).' KZT</p>
