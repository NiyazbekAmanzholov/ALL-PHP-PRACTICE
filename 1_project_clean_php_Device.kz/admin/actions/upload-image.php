...
{
 //в зависимости от номера ошибки выводим соответствующие сообщение
 ...
 case 3: $error_img[] =  'Не удалось загружить часть файла'; break;
 case 4: $error_img[] =  'Файл не был загружен'; break;
 case 6: $error_img[] =  'Отсувствует временная папка.'; break;
...
$imgext = strtolower(preg_replace("#.+\.([a-z]+)$#i", "$1", $_FILES['upload_image']['name']));//определяем расширения
