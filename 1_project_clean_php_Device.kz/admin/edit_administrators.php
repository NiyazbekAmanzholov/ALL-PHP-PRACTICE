...
if ($_SESSION['auth_admin'] == "yes_auth")
{
  ...
  $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> \ <a href='edit_administrators.php' >Изменение администратаров</a>";
...
{
  $msgerror = 'У вас нет прав на изменение администратаров!';
}
...
<div id="block-content">
	<div id="block-parameters">
		<p id="count-page">Изменение администратора</p>
</div>
<?php
...
<label for="add_news">Добавление новости.</label>
</li>


<li>
<input type="checkbox" name="delete_news" id="delete_news" value="1" '.$delete_news.' />
<label for="delete_news">Удаление новости.</label>
</li>
...
<label for="view_admin">Просмотр администратаров.</label>
</li>
