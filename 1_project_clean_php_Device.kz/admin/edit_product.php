...
//функция удаления основной картинки
...
<textarea name="form_seo_description">'.$row["seo_words"].'</textarea>
</li>
'; 
...
';
   ...
   if  (strlen($row["image"]) > 0 && file_exists("../uploads_images/".$row["image"]))//если картинка существует в бд выводим
{
...
}else//если не существует выводим для загрузки фото
{
echo '
<label class="stylelabel" >Основная картинка</label>
