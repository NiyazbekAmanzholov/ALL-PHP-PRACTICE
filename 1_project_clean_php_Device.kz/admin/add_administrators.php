...
if ($_SESSION['auth_admin'] == "yes_auth")
{
  ...
  $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> \ <a href='add_administrators.php' >Дабовление администратаров</a>";
...
if ($_POST["submit_add"])
{
 ...
 }else
 {
   ...
   {
    $msgerror = 'У вас нет прав на дабовление администраторов!';
   }
...
<div id="block-content">
	<div id="block-parameters">
		<p id="count-page">Добавление администратора</p>
</div>
<?php
...
<label for="accept_orders">Обрабдтка заказов.</label>
</li>
...
<label for="add_news">Просмотр новостей.</label>
</li>
...
<label for="add_category">Просмотр категорий.</label>
</li>
