...
if (mysql_num_rows($result) > 0)
{
 ...
 echo '<div id="block-sorting">
      ...
      <li>Сортировать:</li>
      <li><a id="select-sort" href="view_cat.php">Без сортировки</a></li>
        <li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=price-asc">От дешевых</a></li>
        <li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=price-desc">От дорогих</a></li>
