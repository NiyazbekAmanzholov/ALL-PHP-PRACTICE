			      ...
			      <div style="padding-top: 3%;padding-bottom: 3%;margin-left: 3%;" class="col-md-5 form rowBlock main">
			        ...
			        <form action="{{ url('charge') }}" method="post" id="payment-form">
			            <div class="form-row" style="padding-top: 30px;">
			                ...
			                <input type="text" name="email" class="form-control mb-3" value="{{ Auth::user()->email }}" placeholder="Введите Email" />
				            <input type="text" name="address" class="form-control mb-3" placeholder="Введите адрес доставки" />				                
			                <input type="text" name="number" class="form-control mb-3" value="{{ Auth::user()->number }}" placeholder="Введите номер" />	
					...
					<!--2-->
						...
						<div class="rowContainer" style="margin-top: 12%;">            
